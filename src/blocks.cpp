...
//----
	...
	static std::vector<block_info> block_list {
		...
		{ 0x08, "water", 500.0f, 2, 0, 64, true, BS_FLUID },
		{ 0x09, "still-water", 500.0f, 2, 0, 64, true, BS_FLUID },
		{ 0x0A, "lava", 0.0f, 0, 0, 64, false, BS_FLUID },
		{ 0x0B, "still-lava", 500.0f, 0, 0, 64, false, BS_FLUID },
		...
		{ 0x12, "leaves", 1.0f, 1, 0, 64, false, BS_SOLID },
		{ 0x13, "sponge", 3.0f, 15, 0, 64, true, BS_SOLID },
		{ 0x14, "glass", 1.5f, 0, 0, 64, false, BS_SOLID },
