...
#ifndef _hCraft__WORLDGENERATOR__TEST_H_
#define _hCraft__WORLDGENERATOR__TEST_H_
...
namespace hCraft {
	 ...
	 * Testing stuff.
	 */
	class test_world_generator: public world_generator
	{
		std::minstd_rand rnd;
		long gen_seed;
	...
	public:
		 ...
		 */
		test_world_generator (long seed);
