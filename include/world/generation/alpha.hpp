...
#ifndef _hCraft__WORLDGENERATOR__ALPHA_H_
#define _hCraft__WORLDGENERATOR__ALPHA_H_
...
namespace hCraft {
	...
	/* 
	 * The alpha world generator with tons of biomes!
	 */
	class alpha_world_generator: public world_generator
	{
		std::minstd_rand rnd;
		long gen_seed;
	...
	public:
		 ...
		 */
		alpha_world_generator (long seed);
